...
The configuration-space CQ path integral of [[library/covariant-cq-path-integrals/inq|Oppenheim and Weller-Davies]] evolves the components of the density matrix with weight $e^{\mathcal I_{CQ}}$, where
