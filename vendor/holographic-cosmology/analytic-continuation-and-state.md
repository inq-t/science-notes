...
[[library/holography-for-cosmology/inq|McFadden and Skenderis]] give the operational construction, while [[library/cosmological-3-point-correlators-from-holography/inq|their three-point analysis]] carries the continuation through nonlinear response.
...
whereas an AdS or domain-wall construction uses different gluing data. [[library/operator-dictionaries-and-wave-functions-in-ads-cft-and-ds-cft/inq|Harlow and Stanford]] emphasize that continuation of wavefunctions does not make all operator dictionaries or expectation values identical.
