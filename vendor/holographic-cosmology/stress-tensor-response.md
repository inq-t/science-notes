...
The radial Hamiltonian construction is developed in [[library/correlation-functions-in-holographic-rg-flows/inq|Papadimitriou--Skenderis]]. The counterterm and source-response framework is developed in [[library/holographic-renormalization/inq|de Haro--Solodukhin--Skenderis]].
