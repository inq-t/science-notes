...
[[vendor/entropic-gravity/sources/papers/1108.5240-visser-conservative-entropic-forces.pdf|Visser]] studies a conservative one-body force written as
...
[[vendor/entropic-gravity/sources/papers/1009.5414-kobakhidze-gravity-not-entropic-force.pdf|Kobakhidze]] argues that a literal screen-state implementation of the entropy postulate conflicts with coherent neutron bound states. [[vendor/entropic-gravity/sources/papers/1109.2794-chaichian-oksanen-tureanu-entropic-gravity-entropy-postulate.pdf|Chaichian, Oksanen, and Tureanu]] reply that the argument identifies the screen density matrix with the particle state too strongly and that the entropy postulate need not imply the claimed decoherence.
