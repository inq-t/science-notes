...
A proposed normal-form reduction of those marked histories must also transport source products. [[four-face-source-products-and-the-oriented-contact|The four-face contact]] and [[oriented-source-products-and-the-compact-contact-return|its actual compact readout]] show that separately corrected quadratic sources require a derived cubic term in their composite. Their corrected marks can access additional faces. This source-access footprint belongs in the sewing experiment; replacing the inherited state or treating the lift as positive conditional averaging would change the tested law.
