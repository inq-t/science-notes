...
A proposed normal-form reduction of those marked histories must transport products and regional embeddings. [[four-face-source-products-and-the-oriented-contact|The four-face product contact]] has an [[oriented-source-products-and-the-compact-contact-return|actual compact readout]]. [[regional-conditional-projection-and-the-vacuum-score|The actual conditional tangent]] now separates fixed access from the comparison, and [[two-face-source-access-and-the-normal-form-obstruction|the five-by-five obstruction]] rules out matching the entire prepared pair inventory by one odd normal form. [[covariant-boundary-source-and-the-oriented-return|The covariant boundary channel]] retains a nonzero three-face response that neutral scalar pair exchange misses. Its double bracket and nested Casimir contraction are fixed-source conditional data. They must travel with the inherited vacuum and source-access maps before being compared with the history terms in (SB15).
