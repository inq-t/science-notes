...
The gain is a specified algebra-sensitive route from comparisons to a full frame carrier, a potential, a vacuum and a dynamical response. Its group, independent preparation roles, covariance rule, comparison strength and duration calibration remain inputs. A common cosmological source is still to be derived. The single-preparation alternative may constrain mobility and state more tightly; it cannot inherit (PC7) without its own limit calculation.
