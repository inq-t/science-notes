...
The actual uniform conditional theorem controls the integral in CI5 after division by \(h^2\). CI7–9 separately evaluate its harmonic candidate kernel and tail. These facts alone do not prove uniform convergence of the actual time-resolved kernel or of its tails. That next comparison must transport the moving influence observable, the global character insertion and the same original chronology together. A spatially sewn realization must additionally preserve [[regional-innovation-and-exterior-information-balance|RI's exterior channels]] and [[spatial-block-sewing-and-the-vacuum-cap-response|SB's vacuum caps, source exchange and lag terms]]. No complete-source OI bound or four-dimensional physical return has been proved here.
