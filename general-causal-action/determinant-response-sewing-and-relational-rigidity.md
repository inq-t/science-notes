...
[[conditional-cumulant-influence-and-the-original-chronology|The corresponding influence observable]] gives an exact mixed reduced-resolvent response under the original Hamiltonian. It depends on the full retained exterior, even though its underlying mark belongs to one face. [[conditional-character-chronology-and-uniform-temporal-tails|The full actual profile]] now returns uniformly over scaled time and in absolute time integral, with an actual tail uniform in patch size. The proof retains the unprojected influence, the centered global insertion and a comparison map centered in the actual vacuum. Its integral error is \(C_Ih(L+1)^{15/2}\) on the same confinement window. The next test concerns the diagonal spectral measure and OI on the influence's complete chronological family; one returned mixed profile does not establish a complete-source OI bound or the four-dimensional physical return.
