...
[[uniform-marked-well-return-and-the-growing-patch-test|Uniform marked well return]] is the next technical conjecture within this foundation: its proposed bounds would control a joint growing-patch window before interpreting nonlinear coefficients at a crossover scale. Fixed-patch expansions and polynomial coefficient bounds do not establish those uniform remainders. The actual conditional covariance and mixed susceptibility in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] must still travel through assembly.
