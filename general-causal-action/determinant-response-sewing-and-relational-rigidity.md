...
The fourth-order spectral and marked remainders in [[uniform-marked-well-return-and-the-growing-patch-test|uniform marked well return]] remain the next technical test within this foundation. The proved localization supplies spectral isolation; the sharper local row estimates must now control the actual nonlinear operator residual and centered Poisson solution. The actual conditional covariance and mixed susceptibility in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] must still travel through assembly.
