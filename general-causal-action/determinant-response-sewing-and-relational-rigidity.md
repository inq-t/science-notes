...
[[conditional-cumulant-influence-and-the-original-chronology|The corresponding influence observable]] gives an exact mixed reduced-resolvent response under the original Hamiltonian. It depends on the full retained exterior, even though its marked vector belongs to one face. The harmonic time profile has an integrable tail uniform in patch size. Returning that full actual profile remains the next chronological test; the integrated coefficient does not establish a complete-source OI bound or the four-dimensional physical return.
