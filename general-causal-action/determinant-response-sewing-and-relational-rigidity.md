...
The next decisive test is [[strong-seam-corner-and-the-residual-rotor|the complete strong-seam return]]. Keep \(\epsilon\) fixed and send the two physical magnetic strengths to infinity on the same graph. An exact vacuum isometry preserves Haar measure on the central class-function carrier. Its direct Hamiltonian compression stays at the free coefficient, while elimination of the fast derivative coupling predicts a residual rotor with fundamental energy \(10\epsilon/3\). The Euclidean corrector identity fixes this candidate coefficient from the incidence matrix; the full compact-group norm-resolvent limit remains conjectural. [[abelian-corner-and-the-strong-seam-return|The Abelian comparison]] proves its matching flux-sector limit. Neither is a replacement for the whole-carrier spatial and continuum estimate.
