...
The subordinate construction within OI is now source sewing by the Lie bracket. Next derive the same first contact for general compact simple groups from their actual incidence rows and faithful-representation normalization, without relying on quaternion identities or fitting a new clock. The complete-source bound and continuum crossover in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] remain open.
