...
[[compact-source-normalization-and-the-nonlinear-return|The actual nonlinear source expansion]] now retains the changing vacuum and all operator jets. Its [[nonlinear-scalar-source-and-the-vacuum-response-coefficient|first normalized coefficient]] is a gap-shift term plus a nonpositive susceptibility correction from source leakage. [[one-plaquette-nonlinear-source-response|The one-plaquette control]] evaluates their first separation, while [[comb-face-transport-and-the-first-nonlinear-jet|the comb geometry]] proves a nonzero virtual cubic transition on four faces. The next calculation evaluates the full four-face coefficient, including density and mixed derivatives; a selected source's improved quotient can reflect changed spectral weight rather than a strengthened gap. The actual conditional covariance and mixed susceptibility in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] must travel through assembly.
