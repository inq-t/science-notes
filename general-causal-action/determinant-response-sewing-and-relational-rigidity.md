...
[[uniform-nonlinear-planar-gap-and-marked-response|Uniform nonlinear return]] resolves the fourth-order marked-well test with stronger remainders \(Ch^4(L+1)^{21}\) and \(Ch^4(L+1)^{23}\). These terms preserve harmonic softening throughout the confinement window. [[compact-regional-covariance-and-susceptibility-return|The fixed-profile compact return]] now retains inherited regional covariance and finite local susceptibility. [[vacuum-hellinger-return-and-regional-conditional-projections|The actual conditional operator]] also has a positive one-face semigroup defect, equal to the information transported outside that region. [[regional-innovation-and-exterior-information-balance|The exact regional innovation balance]] determines how this channel enters the original response and its squared surplus. [[uniform-collar-capture-and-the-local-gap-limitation|Uniform collar capture]] now bounds its omitted fraction on the complete one-face radial harmonic algebra, with a compact return for the prescribed quadratic. Even the complete local harmonic OI floor stays positive while the global floor closes. The next test therefore retains growing mixed relational source matrices; the complete-source bound and continuum crossover in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] remain open.
