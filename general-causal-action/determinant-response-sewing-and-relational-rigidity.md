...
[[regional-vacuum-score-and-the-three-face-orientation|The actual score]] has zero one- and two-face marginal projections and zero neutral scalar exchange between overlapping pairs, while a three-face orientation is nonzero. [[covariant-boundary-source-and-the-oriented-return|Its covariant boundary source]] retains this information: a double Lie bracket contracts under further conditioning to a linear adjoint response, with the same coefficient obtained directly from the inherited covariance. The compact finite-source return is proved and cannot be retuned by a resonant generator that fixes the vacuum. This is the next source-composition datum to transport through nonnested regions. It supplies neither a new Hamiltonian term nor a uniform OI bound. The complete-source estimate and continuum crossover in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] remain open.
