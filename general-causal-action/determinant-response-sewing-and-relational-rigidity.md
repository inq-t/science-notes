...
The subordinate construction within OI is **source sewing by the Lie bracket**. [[weighted-character-scale-and-bounded-lie-sources|The weighted scale]] and [[all-group-oriented-kinetic-jet-and-source-lift|actual all-group incidence calculation]] give the same normalized first contact for every compact connected simple group. [[lie-bracket-source-contact-and-the-positive-comparison-test|Its Gaussian contraction]] retains \(\mathfrak F_Q\), and a same-measure \(L^2\) Schwarz test excludes positive conditional averaging as the complete scalar lift. [[fixed-group-compact-vacuum-and-oriented-source-return|Fixed-group localization]] proves the actual four-face finite polynomial source and composite return. On the larger patch, [[five-by-five-resonance-and-the-source-selection-test|all resonant components of the first odd kinetic jet vanish]], but [[oriented-triad-resonance-and-the-physical-source-block|resonant presentation freedom]] still changes the scalar contact while preserving complete chronological operator words through first order. [[resonant-source-transport-and-fixed-regional-access|A one-face access test]] detects every member of that freedom when its regional embedding is held fixed. Next construct the transport of those embeddings and test overlapping-region sewing. This does not supply a uniform source law or transfer the \(SU(2)\) nonlinear gap correction to another group. The complete-source bound and continuum crossover in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] remain open.
