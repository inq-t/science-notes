...
\tag{DS10h}
\]
The innovation carrier is \(\mathscr K_0=\overline{\delta_+\mathscr H_0}\). [[two-slice-innovation-geometry/oriented-innovation-and-finite-temporal-repair|The oriented construction]] owns the proofs. Its finite chronological word
...
The spatial estimates must allow redistribution of spectral weight. [[adjacent-wilson-plaquette-and-the-chronological-surplus|The adjacent-plaquette calculation]] shows that a seam can improve one source quotient while decreasing the complete gap; [[corner-response-and-the-failure-of-multiplicative-attenuation|the corner calculation]] rejects multiplication of separately measured attenuation factors. [[strong-seam-resolvent-and-the-physical-rotor|The strong-seam theorem]] nevertheless returns a complete rotor at fixed spatial configuration. These are distinct limits of the same programme, with their actual vacua and clocks retained.

Growing regions expose a separate obstruction. [[planar-patch-confinement-and-the-spatial-soft-mode|Planar confinement]] has a closing harmonic coefficient, and [[uniform-nonlinear-planar-gap-and-marked-response|the uniform nonlinear return]] preserves its softening in the stated confinement window. [[two-slice-innovation-geometry/regional-innovation-and-exterior-information-balance|Regional innovation]] splits the inherited full response from extra prediction error caused by forgetting the exterior. [[uniform-collar-capture-and-the-local-gap-limitation|The collar theorem]] shows that even a complete local radial floor can coexist with a closing global floor. [[finite-pairing-range-and-the-harmonic-innovation-floor|Pairing range]] and [[compact-quadratic-carrier-and-the-pairing-range-return|its compact return]] quantify that collective escape.

The subordinate constitutive proposal is **source sewing by the Lie bracket**. [[all-group-oriented-kinetic-jet-and-source-lift|The all-group kinetic jet]] supplies the first oriented contact, while [[oriented-source-lift-and-the-positive-comparison-obstruction|the positive-map obstruction]] proves that its complete multiplier lift cannot be replaced by ordinary positive conditional averaging. [[two-face-source-access-and-the-normal-form-obstruction|The source-access test]] requires the retained embedding response. [[conditional-boundary-translation-and-source-products|Conditional boundary messages]] restore the original source products and both elimination orders at the calculated order; exact Gaussian promotion fails joint normalization. The higher conditional law must therefore remain in the construction.

Chronological closure tests the entire visible spectrum. [[radius-orientation-source-extension-and-the-innovation-floor|Adding oriented sources]] lowers an apparently reinforced radius-only quotient. [[equal-character-hessians-and-the-nonlinear-source-discriminator|Equal quadratic and first-order preparation data]] can have different fourth cumulants and actual gaps. [[conditional-character-chronology-and-uniform-temporal-tails|The actual influence profile]] has a controlled time integral, yet [[conditional-influence-soft-band-and-chronological-filters|its normalized chronological filters]] expose a closing scaled floor. [[two-slice-innovation-geometry/chronological-cyclic-sources-and-the-innovation-floor|The cyclic-source theorem]] explains why one finite susceptibility cannot exclude such soft spectral weight. Fixed physical duration and the rapidly confining scaled limit remain different tests.

The latest closed-cell construction retains the dependent face and all original edge derivatives. [[closed-cube-bracket-source-and-the-actual-vacuum-return|The cube source return]] reaches an existing neutral level; its positive bracket mean is not an added floor. [[two-cube-temporal-sewing-and-the-actual-joint-source|Shared-cell temporal sewing]] preserves the global vacuum caps and one copy of each shared term. At complete attachment, [[two-cube-interior-cost-and-the-joint-bracket-response|the harmonic source-support calculation]] misses the lowest physical modes. The next test is the actual nonlinear lowest-cluster projection of that fixed source, with the full preparation and original clock retained. This tests source coverage; the complete-source and continuum estimate remains the distinct conjecture in [[physical-response-coercivity/conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]].

[[paired-boundary-return-and-the-same-wall-identity|The paired-boundary calculation]] keeps the modular alternative correctly typed: same-boundary retraction is the identity, opposite-boundary chronological return is \(P^*P\), and the KMS and BKM comparisons require their own source maps. None replaces the selected chronological law merely by sharing its vocabulary.
