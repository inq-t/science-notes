...
[[covariant-source-memory-and-the-first-chronological-response|The actual chronological test]] now gives a nonzero mixed exterior coefficient on physical scalar radius and Cartan-triple sources, even though their diagonal first coefficients vanish. The generator, regional projection and vacuum measure all change together. This supplies an entry of RI's mixed exterior form on a fixed patch; the next source-extension comparison must retain the complete innovation numerator and changing denominator before assessing rigidity.
