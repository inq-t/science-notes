...
The next subordinate construction within OI is one oriented source lift supplied by the odd kinetic term. Test its compatibility with source multiplication, including any forced contact term, before extending the known correction probe by probe. This is a test of the source-composition rule, not a modification of the physical clock. The complete-source bound and continuum crossover in [[conditional-vacuum-rigidity-and-the-physical-gap|CV8–14]] remain open.
