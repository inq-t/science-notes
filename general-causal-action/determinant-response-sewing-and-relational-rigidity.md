...
The next constitutive test of source sewing is [[closed-cube-face-words-and-the-prepared-amplitude|a complete closed-cell boundary]]. Its five independent loop coordinates force the sixth face word \(v^{-1}w^{-1}xuy\), with the same prepared face factor and all marks retained. Derive the original raw-edge kinetic form in that chart and isolate a joint non-Abelian response that cannot be supplied by independent-face factors. No new mass term or independent sixth-face parameter is inserted. The graph also admits a planar sphere drawing; cell incidence and shared-cell sewing must remain explicit before any three-dimensional interpretation. This is a concrete extension of the subordinate construction within OI, not a second foundational conjecture or a claimed gap theorem.
