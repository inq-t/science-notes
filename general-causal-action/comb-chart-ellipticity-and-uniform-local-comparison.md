...
These are bounds on exact local coefficient operators and their formal eigenpairs. They prove neither convergence of the formal series nor a uniform actual operator Taylor remainder on a cutoff quasimode. Applying them to the compact theory still requires that remainder, cutoff derivatives, and the actual spectral and source-return estimates.
