...
[[four-face-oriented-normal-form-and-the-universal-source-lift|The fixed four-face normal form]] now solves \([K_0,S_1]=-V_1\) on the full polynomial-Gaussian core, with every repeated-mode angular row retained. Its third-derivative coefficient cannot be represented by a point-coordinate vector field. [[four-face-source-products-and-the-oriented-contact|The resulting source contact]] is invariant under faithful first-order point-coordinate and half-density changes. This makes a concrete distinction between presentation transport and discarding the differential part of a physical source.
