...
The result closes the specified finite three-cell incidence mismatch by adding the two actual bridge actions. [[shared-preparation-actions-and-the-conditional-return|The shared-action construction]] supplies the separate positivity and return proof when matrices are reused, with the ancestral preparation law and actual port transport retained. [[bridge-forgetting-and-the-inherited-marked-transfer|The spatial marginal theorem]] identifies the inherited composite marked experiment and distinguishes it from a newly calibrated Gaussian comparison. Selection of the action inventory, correlated preparation and growing-diagram law remains open. Finite calibration supplies no estimate uniform over growing interacting spatial diagrams.
