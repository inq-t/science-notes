...
The next bounded test is therefore to specify and test a common source-selection rule for this resonant freedom, retaining products and the physical carrier. Setting the resonant part to zero is a possible convention, not a consequence of the kinetic commutator or vacuum alone. This calculation supplies no spatially uniform inverse bound, actual all-orders transport, or continuum mass-gap conclusion.
