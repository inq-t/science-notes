...
[[uniform-weighted-character-return-and-the-soft-gap|The weighted-character extension]] verifies the changed potential and uniform well before applying this proof structure to EH's preparation family. Differentiating its finite quasimode construction yields the sharper gap-contrast error \(C_I|\varepsilon_2-\varepsilon_1|h^4n^{13}\), because only single-face multiplication terms vary. That estimate resolves a contrast too small for subtracting two instances of the \(n^{21}\) remainder. [[magnetic-parameter-tangents-and-uniform-vacuum-control|The normalized vacuum-tangent estimate]] and [[conditional-replica-cumulants-and-amplitude-stability|conditional replica stability]] additionally supply [[uniform-local-conditional-character-return|a uniform return of the integrated fourth-cumulant contrast]], with its conditional products and changing marginal retained.
