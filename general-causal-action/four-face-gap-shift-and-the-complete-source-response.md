...
The finite test therefore requires the elementary law to control the complete source carrier, including the oriented cubic comparisons. A criterion based only on the original quadratic source would draw the wrong conclusion about this gap correction.
