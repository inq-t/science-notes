...
This test retains off-diagonal \(X_p\cdot X_q\), not merely correlations between scalar readouts. [[compact-quadratic-carrier-and-the-pairing-range-return|The compact quadratic return]] now controls every signed symmetric matrix, including growing inventories, and preserves the range response on its confinement and duration window. [[conditional-vacuum-rigidity-and-the-physical-gap|CV]] still owns the complete physical source obligation, and [[spatial-block-sewing-and-the-vacuum-cap-response|SB]] owns the additional history terms. The quadratic carrier is not the complete compact observable space.
