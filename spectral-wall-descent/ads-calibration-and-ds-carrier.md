...
Primary sources: [[library/canonical-energy-is-quantum-fisher-information/inq|canonical energy as quantum Fisher information]], [[library/relative-entropy-equals-bulk-relative-entropy/inq|JLMS relative entropy]], [[library/operator-algebra-quantum-error-correction/inq|operator-algebra quantum error correction]], [[library/extension-of-borchers-structure-theorem/inq|half-sided modular inclusions]], [[library/pseudo-supersymmetry-and-the-domain-wall-cosmology-correspondence/inq|the domain-wall/cosmology correspondence]], [[library/holography-for-cosmology/inq|holography for cosmology]], [[library/de-sitter-observables-algebra/inq|the de Sitter static-patch algebra]], [[library/generalized-entropy-for-general-subregions-in-quantum-gravity/inq|general gravitational subregion entropy]], and [[library/subregion-algebras-in-classical-and-quantum-gravity/inq|horizon subregion algebras]].
