...
This is the right-hand side of the Bekenstein entropy bound in natural-log units, not the actual entropy of every system. In quantum field theory, [[library/relative-entropy-and-the-bekenstein-bound/inq|Casini's relative-entropy formulation]] supplies a controlled interpretation for suitable regions and states.
...
First-order modular energy and second-order BKM geometry should not be identified merely because both are information-theoretic. Controlled holographic results such as [[library/canonical-energy-is-quantum-fisher-information/inq|canonical energy as quantum Fisher information]] show that a second-order equality can exist in a specified regime; they do not establish it for a dynamical FLRW wall.
