...
Every step is Schur's lemma over a division algebra. And up to Morita equivalence, since $M_3(\mathbb C)\simeq\mathbb C$ while $\mathbb H$ is inequivalent to $\mathbb R$ over $\mathbb R$,
