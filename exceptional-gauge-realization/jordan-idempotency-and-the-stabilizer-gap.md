...
[[exceptional-gauge-realization/receipts/jordan_idempotency_gap_receipt.py|The Peirce receipt]] and [[exceptional-gauge-realization/receipts/jordan-idempotency-gap-receipt-output.txt|its stored output]] verify the idempotency spectra and dimension balances. [[algebra/receipts/exceptional_flag_linearization_receipt.py|The flag-linearization receipt]] and [[algebra/receipts/exceptional-flag-linearization-receipt-output.txt|its stored output]] prove the standard continuous constraint's kernel dimension by exact modular rank plus the cited orbit dimension. The [[exceptional-gauge-realization/receipts/exceptional_normal_holonomy_receipt.py|normal-holonomy receipt]] checks the reduced Hessian ledger, faithful-normal representation arithmetic, and exact color-Wilson normalization. These receipts do not prove physical chirality, select a Yang--Mills carrier or state, or imply a continuum gap.
