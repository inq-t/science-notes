...
- W. Rindler, [[library/visual-horizons-in-world-models/entry|“Visual Horizons in World Models”]] (1956; publisher record): the foundational distinction between particle and event horizons in Robertson--Walker cosmology.
- Roger Penrose, [[library/asymptotic-properties-of-fields-and-spacetimes/entry|“Asymptotic Properties of Fields and Space-Times”]] (1963; publisher record): the conformal treatment of causal infinity underlying conformal diagrams.
- Leonard Parker, [[library/quantized-fields-and-particle-creation-i/entry|“Quantized Fields and Particle Creation in Expanding Universes. I”]] (1969; publisher record): quantum fields and particle creation in a spatially flat expanding universe.
- Chung-Pei Ma and Edmund Bertschinger, [[library/cosmological-perturbation-theory-in-the-synchronous-and-conformal-newtonian-gauges/entry|“Cosmological Perturbation Theory in the Synchronous and Conformal Newtonian Gauges”]] (1995; repository record): conformal-time Einstein--Boltzmann perturbation equations used in CMB and structure calculations.
