...
[[mass-scale-calibration/mass-as-casimir-and-realization]]. The scale \(R_r\) must be selected
...
[[categorical-gauge-response/categorical-action-on-the-neutral-wilson-carrier]] is the non-group version
