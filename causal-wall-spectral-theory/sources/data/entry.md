...
The relevant analyses are [[library/act-dr6-power-spectra-likelihoods-lambda-cdm/entry|the DR6 spectra and baseline-parameter paper]] and [[library/the-atacama-cosmology-telescope-dr6-constraints-on-extended-cosmological-models/entry|the extended-model paper]]. The [[causal-wall-spectral-theory/sources/snapshots/act-dr6.02-release.html|local DR6.02 release page]] records the official product structure.
...
The archived tensor calibration in [[causal-wall-spectral-theory/empirical-targets|the empirical-target ledger]] comes from [[library/bicep-keck-2018-primordial-gravitational-waves/entry|the BK18 analysis]]. The official release has DOI `10.71662/5etq-eh39`; the [[causal-wall-spectral-theory/sources/snapshots/bicep-keck-products.html|local product page]] records file descriptions and release sizes.
