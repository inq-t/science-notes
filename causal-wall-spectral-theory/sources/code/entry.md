...
- [[data/planck-2018-release-3-cosmology-products/inq|Planck Release-3]] includes the legacy `clik` 3.01 C, Fortran, and Python likelihood stack supplied with its data products.
- [[data/planck-2015-release-2-cosmology-products/inq|Planck Release-2]] includes `clik` 2.0, while [[data/bicep2-keck-planck-2015-joint-likelihood/inq|the 2015 BKP module]] owns the associated joint likelihood package.
- [[data/bicep-keck-2018-data-products/inq|The BK18 module]] owns the CosmoMC likelihood and released $r$--$n_s$ companion package.
