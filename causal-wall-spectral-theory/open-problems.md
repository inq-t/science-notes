...
[[wall-construction-interface/core-spectral-wall|The core spectral wall]] now supplies an exact algebraic pre-wall: finite corners carry trace-capacity, while labelled whole-core fibers carry one state orbit, exact transport, a binary readout, and nonzero homogeneous response. It supplies neither the causal/local carrier and source readiness of physical W0 nor the physical quotient or mean-zero Weyl/TT directions required by W1\(_{\mathrm s}\) and W1\(_{\mathrm t}\). [[wall-construction-interface/half-sided-modular-tunnel|The half-sided-modular tunnel]] and [[wall-construction-interface/finite-cellular-markov-wall|the cellular Markov wall]] remain useful orientation and finite-response benchmarks. [[program-core/physical-quotient|The physical quotient]] is a programme-core gate rather than a W0 return value, and [[program-core/center-valued-response|W1 central response]] must retain the sector law before any scalar policy.
