...
| [[program-core/ruble-equations#RE2 — Distinguishability response and localization|RE2]] | CWST seeks the center-resolved mean-zero package \(\mathfrak G^Z_{\zeta\zeta}=(Z,\mathbf G^Z_{\zeta\zeta},\omega^Z)\) of [[program-core/common-response-matrix|the common response geometry]]. | exact finite-center response law; open carrier, localization, and wall return |
