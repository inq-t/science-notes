...
The required output is the package in [[compatible-with-existing-physics/primordial-observable-interface|the primordial observable interface]]: reduced scalar and tensor phase spaces, symplectic normalization, Lorentzian equations and constraints, a state, matching data, and the map to late observables.
