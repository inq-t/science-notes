...
- A [[basic-concepts/sheafs/entry|sheaf]] organizes compatible local data over varying regions. A coalgebra organizes decomposition or behavior. A sheaf may take values in coalgebras, but neither notion entails the other.
- A [[basic-concepts/stacks/entry|stack]] records objects with automorphisms satisfying descent. The “coalgebra of behaviors” and the “stack of locally gluable objects” solve different structural problems.
