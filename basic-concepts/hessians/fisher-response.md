...
Fisher introduced the statistical information associated with estimation in [*On the Mathematical Foundations of Theoretical Statistics*](https://doi.org/10.1098/rsta.1922.0009). Kullback and Leibler introduced the divergence used in the coincidence expansion in [*On Information and Sufficiency*](https://doi.org/10.1214/aoms/1177729694). Kubo's [statistical-mechanical response paper](https://doi.org/10.1143/JPSJ.12.570) is part of the quantum-response lineage, but its causal dynamical response must not be inferred from the static Fisher calculation. Petz's [classification of monotone matrix metrics](https://doi.org/10.1016/0024-3795(94)00211-8) and [Grasselli--Streater's finite-dimensional uniqueness theorem](https://arxiv.org/abs/math-ph/0006030) delimit the stronger hypotheses under which BKM is selected in noncommutative information geometry.
