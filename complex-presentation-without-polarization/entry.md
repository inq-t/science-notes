...
Their common lesson is more abstract and more durable: locally simple branches can acquire global individuality through monodromy, degeneration, and nontrivial gluing. [[a2-ternary-response/entry|The $A_2$ ternary-response module]] asks what state geometry arises when three such branches are treated before a binary wall has selected two of them.
