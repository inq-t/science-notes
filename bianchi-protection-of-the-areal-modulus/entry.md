...
not \(Q_\xi[\Sigma_2]=Q_\xi[\Sigma_1]\) for an open subsystem. [[conservation-of-causal-charge/diagonal-charge-balance|Diagonal charge balance]] states the exact Hamiltonian template, while [[flux-record-and-top-form-realizations/entry|the realization module]] keeps Noether flux distinct from K-theory boundary maps and top-form flux.
...
- the last expression is the conditional fossil bulk-cell closure of [[bulk-area-cell-normalization/entry|the normalization module]].
...
Conversely, Bianchi protection says nothing about whether the wall possesses a stable K-class. The proposed Baum--Connes naturality square in [[flux-record-and-top-form-realizations/entry|the assembly analysis]] is ancillary to this module, not a premise of its proof.
