...
In the supplied Jaffe–Witten description, the missing example is a mathematically complete four-dimensional quantum gauge theory. The article surveys lower-dimensional constructions and substantial but incomplete ultraviolet control for four-dimensional gauge theory. This is a report of the constructive problem, not a theorem that the target axioms are inconsistent. [[clay-contract-and-scale-assumptions|The source-assumption audit]] distinguishes that historical assessment from the freedom to introduce a new construction framework.
