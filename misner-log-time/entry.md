...
The $N_e$ convention in [[conformal-scale-geometry/flrw-scale-section-kinematics|FLRW scale-section kinematics]] therefore runs in the opposite direction to the conventional Misner $\Omega$: expansion increases $N_e$ and decreases $\Omega$.
...
- Charles W. Misner, [[misner-log-time/sources/1969-misner-quantum-cosmology-i.pdf|“Quantum Cosmology. I”]] (1969; [publisher record](https://doi.org/10.1103/PhysRev.186.1319)): the Hamiltonian treatment of homogeneous cosmologies and its quantum version.
- Charles W. Misner, [[misner-log-time/sources/1969-misner-mixmaster-universe.pdf|“Mixmaster Universe”]] (1969; [publisher record](https://doi.org/10.1103/PhysRevLett.22.1071)): the Bianchi IX singular dynamics that made the logarithmic scale variable especially useful.
- Charles W. Misner, [[misner-log-time/sources/1994-misner-mixmaster-cosmological-metrics-arxiv-source/9405068.tex|“The Mixmaster Cosmological Metrics”]] (1994; [repository record](https://arxiv.org/abs/gr-qc/9405068)): a retrospective account of the model, its equations, and the Misner--Chitré development. The complete arXiv source package and figures are preserved locally.
- Leonardo Agostini, Francesco Cianfrani, and Giovanni Montani, [[misner-log-time/sources/2017-agostini-cianfrani-montani-bianchi-i-internal-time.pdf|“Probabilistic interpretation of the wave function for the Bianchi I model”]] (2017; [repository record](https://arxiv.org/abs/1704.08502)): an explicit comparison of reduced-phase-space and semiclassical treatments using the isotropic Misner variable as time.
