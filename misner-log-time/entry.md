...
- Charles W. Misner, [[library/quantum-cosmology-i/entry|“Quantum Cosmology. I”]] (1969; publisher record): the Hamiltonian treatment of homogeneous cosmologies and its quantum version.
- Charles W. Misner, [[library/mixmaster-universe/entry|“Mixmaster Universe”]] (1969; publisher record): the Bianchi IX singular dynamics that made the logarithmic scale variable especially useful.
- Charles W. Misner, [[library/the-mixmaster-cosmological-metrics/9405068.tex|“The Mixmaster Cosmological Metrics”]] (1994; [[library/the-mixmaster-cosmological-metrics/entry|repository record]]): a retrospective account of the model, its equations, and the Misner--Chitré development. The complete arXiv source package and figures are preserved locally.
- Leonardo Agostini, Francesco Cianfrani, and Giovanni Montani, [[library/probabilistic-interpretation-of-the-wave-function-for-the-bianchi-i-model/entry|“Probabilistic interpretation of the wave function for the Bianchi I model”]] (2017; repository record): an explicit comparison of reduced-phase-space and semiclassical treatments using the isotropic Misner variable as time.
