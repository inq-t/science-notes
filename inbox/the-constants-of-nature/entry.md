...
| G6 | **Born positivity at the crossing.** OS reflection at u ↦ −u; Bochner certificate FT[sech²](k) = πk/sinh(πk/2) > 0; the negative branch (negative mass/spacetime) is forced into positivity. | certificate [EXACT]; OS reconstruction [OPEN CONSTRUCTION] | the-carrier-and-zeta; the-freezing-law |
...
| FT[sech²](k) = πk/sinh(πk/2) > 0 | Born positivity certificate (Bochner) |
