---
inq.module: "cauchy-spectral-envelope"
inq.include:
  - "**/*.md"
---
...
The starting source is [[library/lorentzian-kernel-epistemic-envelope/inq|Sigtermans' non-peer-reviewed TEQ preprint]]. Its Gaussian-mixture calculation is correct after normalization. The present note extracts that calculation, places it in functional calculus, and audits the larger claims made around it.
