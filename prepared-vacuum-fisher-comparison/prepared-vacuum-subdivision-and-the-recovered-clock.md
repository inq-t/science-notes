# Prepared Vacuum Subdivision and the Recovered Clock

Rebuilding independent paired-path sources after inserting redundant vertices changes the Fisher response while preserving the full physical state, Hamiltonian and observable carrier. Uniform subdivision dilutes the correction and makes the calibrated response operators converge in norm resolvent to the supplied physical clock. This limit tests the preparation rule; it introduces no new physical degrees of freedom and selects no new dynamics.
...
[[holonomy-state-refinement/holonomy-refinement-and-clock-compatibility#A product holonomy has an additive diffusion budget|Additive electric weights]]
...
[[prepared-vacuum-fisher-comparison/physical-vacuum-lift-and-fisher-comparison|the physical-vacuum lift]].
...
[[prepared-vacuum-fisher-comparison/receipts/prepared_vacuum_subdivision_receipt.py|the prepared-vacuum receipt]].
...
[[gauge-source-action-transport/source-action-transport-through-ordered-cuts|Transporting complete source actions]]
...
[[prepared-vacuum-fisher-comparison/coherent-source-subdivision#Coherent spatial extension retains its reference experiment|The coherent spatial extension]]
