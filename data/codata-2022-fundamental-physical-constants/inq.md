...
- **Local files:** [[data/codata-2022-fundamental-physical-constants/nist-2022-codata-all-constants.txt|the ASCII table]] and [[data/codata-2022-fundamental-physical-constants/nist-2022-codata-recommended-values.pdf|the PDF listing]] are bundled with this module.
- **Git status:** both compact source files are tracked.
