...
[[overlap-kernels-and-face-refinement|the overlap construction]].
...
[[overlap-kernels-and-face-refinement#Integrating the shared edge produces a joint law|exact two-face convolution]]
...
The existing [[receipts/boundary_charge_gluing_receipt.py|boundary receipt]]
