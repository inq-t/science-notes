# Local Interaction Likelihoods and the Global Source Response

A compatible family of interacting conditional laws determines the cost of every finitely supported source change, including the interactions crossing its boundary. The entropy Hessian supplies a global Fisher stiffness without requiring a density for the infinite system relative to a product measure. Its inverse is not assembled by independently inverting regional blocks: the exterior contributes a Schur correction. Under a uniform small-interaction bound, that correction has controlled tails and the full invariant-cylinder response closes. The interaction and heat geometry remain inputs; neither the physical vacuum nor its translation gap is supplied by this construction.
...
[[haar-vertex-source-and-joint-gauge-response|the Haar-vertex construction]].
...
[[path-shift-fisher-geometry-before-gauge-projection|heat-path likelihoods]].
Then
\[
\boxed{
...
[[loop-correlations-and-the-source-response|the finite-source entropy identity]].
...
This is actual
[[trace-dirichlet-descent/conditional-score-shorting-and-observable-lifts|Fisher shorting]],
...
[[receipts/local_interaction_assembly_receipt.py|The interaction-assembly receipt]]
...
repair the separate
[[loop-correlations-and-the-source-response#Ordinary subdivision preserves the state but changes this response|interacting subdivision obstruction]].
...
[[physical-vacuum-lift-and-fisher-comparison|The actual-vacuum recovery test]]
