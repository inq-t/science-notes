# A Fractional-Susceptibility Ansatz Does Not Preserve the CST-B2 Response Maximum
...
[[causal-scale-theory/theorems/rigid-sech-response-identities|The CST-B2 rigid-response theorem]] owns the identities that the shortcut fails to preserve. The load-bearing distinction is that the constitutive law in [[program-core/ruble-equations|the Ruble equations]] anchors a dimensionful density conversion at the distinguished reference cut; it does not identify the instantaneous fractional abundance with the normalized binary susceptibility.
