...
2. the integrated crossing definition
   ...
   $$
3. the open identification \(T_c=T_{\mathrm{hor},c}\); and
4. the flat Einstein--FLRW identity from [[conformal-scale-geometry/dimensional-horizon-conversion|dimensional horizon conversion]],
   $$
   \frac{k_BT_{\mathrm{hor},c}(S_c/k_B)}{V_c}
   =\frac{2}{d-1}\rho_{\mathrm{crit},c}.
   $$

Substitution gives the **[CONDITIONAL OUTPUT]**
...
Adding the independent weak principle \(\mathfrak R_c=1\), and restricting to \(d>2\), yields
