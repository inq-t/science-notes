...
The DESI collaboration identifies the Gaussian BAO files as the likelihood products used for its DR2 cosmology analysis: [DESI DR2 BAO cosmology results](https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/README.html). The measurements and cosmological analysis are in [DESI DR2 Results II](https://doi.org/10.48550/arXiv.2503.14738). Pantheon+ sample and cosmology methods are described by [Scolnic et al.](https://doi.org/10.3847/1538-4357/ac8b7a) and [Brout et al.](https://doi.org/10.3847/1538-4357/ac8e04).
...
The DES-Dovekie files are the unmodified products at DES-SN5YR commit `c9a4fcafc4cbd19bd750dee47fc76194a45c181f`. The `.npz` product contains an upper-triangular **inverse** covariance, not a covariance. Its ordering matches `DES-Dovekie_HD.csv`; the release warns that the larger metadata table has a different ordering. [Popovic et al.](https://doi.org/10.1093/mnras/stag632) own the recalibration and cosmology analysis, while the collaboration's [likelihood implementation](https://github.com/des-science/DES-SN5YR/blob/main/5_COSMOLOGY/Dovekie_cosmosis_likelihood.py) owns the compact data interface and nuisance convention.
...
[DESI DR2 Results IV, version 3](https://doi.org/10.48550/arXiv.2607.27410) reports at \(z_{\mathrm{eff}}=2.33\)
