...
For a fixed Hamiltonian and temperature, [[basic-concepts/hessians/gibbs-free-energy-relative-entropy|the Gibbs--relative-entropy identity]] makes free-energy excess equal \(k_BT\) times relative entropy. At coincidence, its second variation is the relevant information metric. This is an exact local response statement under its declared hypotheses.

The CST law adds three physical choices:

1. it selects the reflection-odd horizontal block and its extensive full-cut normalization;
