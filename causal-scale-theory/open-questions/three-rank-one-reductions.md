...
Category theory can express horizontal channel rank as factorization through an image object, clock rank as transport over one common base, and stress-response rank as the rank of constrained cohomology or a reduced physical image. These formulations sharpen the differences; they do not identify the carriers. Promoting the three reductions to one theorem would require explicit functors between them, rank-preserving natural transformations after quotient and constraint reduction, and control of kernels and discarded modes. Neither the degree-three \(A_2\) cover nor its rank-three pushforward supplies those maps. No such theorem is presently available.
