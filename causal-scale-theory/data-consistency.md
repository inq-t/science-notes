...
over 24,497 weighted chain rows. This reproduces the compressed quantity from primary products, but the tight posterior is conditional on the base-\(\Lambda\)CDM carrier. It is not a model-neutral CMB likelihood and must not be presented as one. [[causal-wall-spectral-theory/sources/data/entry|The Planck source ledger]] owns the archived official chain; [Planck 2018 VI](https://doi.org/10.1051/0004-6361/201833910) owns the primary cosmological-parameter analysis.
...
The direct fit above uses the public Pantheon+ release and no CMB. The August 2026 [DESI DR2 Results IV](https://doi.org/10.48550/arXiv.2607.27410) analysis supplies a useful but differently conditioned cross-check. With DESI, CMB, and DES-Dovekie supernovae it reports
...
- globular-cluster dating gives \(t_U=13.5^{+0.16}_{-0.14}\ \text{(stat.)}\pm0.23\ \text{(sys.)}\ \mathrm{Gyr}\), or \(0.27\ \mathrm{Gyr}\) combined in quadrature ([Valcin et al.](https://doi.org/10.1088/1475-7516/2021/08/017)).
