...
[[prepared-vacuum-fisher-comparison/prepared-vacuum-subdivision-and-the-recovered-clock|The prepared-vacuum Fisher test]]
...
spacing. The
[[holonomy-state-refinement/receipts/overlapping_plaquette_transfer_receipt.py|overlapping-plaquette receipt]]
...
[[holonomy-state-refinement/overlap-kernels-and-face-refinement#Temporal sewing needs a separate refinement law|overlap temporal sewing]]
...
[[holonomy-state-refinement/heat-state-continuity-and-response-closability|An exact area-dependent]] now tests a change outside the bounded-density branch.
...
[[gauge-path-fisher-response/shared-driver-response-and-the-nested-holonomy-clock|A shared driving]] gives a closed replacement on the full nested-holonomy path sector,
