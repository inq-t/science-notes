...
[[holonomy-state-refinement/heat-state-continuity-and-response-closability|The nested-loop heat-state test]]
...
The existing [[gauge-boundary-frame-gluing/receipts/boundary_charge_gluing_receipt.py|boundary-gluing receipt]]
...
[[gauge-boundary-frame-gluing/receipts/boundary-charge-gluing-receipt-output.txt|The saved output]]
