---
inq.module: "modular-structure-and-duality-in-conformal-quantum-field-theory"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Authors:** R. Brunetti, D. Guido, and R. Longo.
- **Year:** 1993.
- **First submitted:** 1993-02-25.
- **Primary category:** `math.FA`.
- **arXiv:** [funct-an/9302008v1](https://arxiv.org/abs/funct-an/9302008).
- **Publication:** Commun.Math.Phys.156:201-220,1993.
- **DOI:** [10.1007/BF02096738](https://doi.org/10.1007/BF02096738).
- **Local artifacts:** `funct-an-9302008-brunetti-guido-longo-modular-structure.pdf`.
