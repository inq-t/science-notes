---
inq.module: "emergent-gravity-and-the-dark-universe"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Year:** 2017.
- **First submitted:** 2016-11-07.
- **Last revised:** 2016-11-08.
- **Primary category:** `hep-th`.
- **arXiv:** [1611.02269v2](https://arxiv.org/abs/1611.02269).
- **Publication:** SciPost Phys. 2, 016 (2017).
- **DOI:** [10.21468/SciPostPhys.2.3.016](https://doi.org/10.21468/SciPostPhys.2.3.016).
- **Local artifacts:** `1611.02269-source.tar.gz`, `1611.02269-verlinde-emergent-gravity-dark-universe.pdf`.
