---
inq.module: "operator-dictionaries-and-wave-functions-in-ads-cft-and-ds-cft"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Authors:** Daniel Harlow and Douglas Stanford.
- **Year:** 2011.
- **First submitted:** 2011-04-13.
- **Last revised:** 2011-04-21.
- **Primary category:** `hep-th`.
- **arXiv:** [1104.2621v2](https://arxiv.org/abs/1104.2621).
- **Local artifacts:** `1104.2621-harlow-stanford-operator-dictionaries-wave-functions.pdf`.
