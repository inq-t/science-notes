...
David Sigtermans, Independent Researcher, The Netherlands.

- Preprints.org, posted 16 June 2025, version 2. DOI [10.20944/preprints202506.0446.v2](https://doi.org/10.20944/preprints202506.0446.v2). Not peer-reviewed. Licensed CC BY 4.0.

Author's keywords: entropy geometry; minimal principle; entropy-weighted action; Lorentzian kernel; Gaussian kernel; resolution scale; path integral; coarse-graining; distinguishability; Rayleigh distribution.

Files: `preprints202506.0446.v2.pdf` (14 pages). No LaTeX source is available.

The abstract above is transcribed from the `Abstract:` block of the preprint. Pages 1–2 of the PDF are the Preprints.org cover sheet and publisher disclaimer, not the article.
