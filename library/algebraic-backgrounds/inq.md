---
inq.module: "algebraic-backgrounds"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
Fabien Besnard. The source package records no affiliation.

- [arXiv:1902.09387v2](https://arxiv.org/abs/1902.09387) [math-ph], revised 18 November 2019.
- The arXiv journal reference records publication in two parts: *J. Math. Phys.* **60**, 123507 (2019), DOI [10.1063/1.5116922](https://doi.org/10.1063/1.5116922); and *J. Math. Phys.* **60**, 123506 (2019), DOI [10.1063/1.5095562](https://doi.org/10.1063/1.5095562). The published part I is titled "Algebraic backgrounds for noncommutative Kaluza-Klein theory. I. Motivations and general framework".

Files: `AB4MAJ.tex`, `AB4MAJ.bbl`.

The abstract above is transcribed from `\begin{abstract}` in `AB4MAJ.tex`, with `\CC` and `\HH` expanded to $\mathbb{C}$ and $\mathbb{H}$. The file is Latin-1 encoded, not UTF-8. "stricty" is the author's; the arXiv abstract field reads "strictly".
