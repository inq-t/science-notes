...
- **Authors:** Christopher Eling, Raf Guedens, and Ted Jacobson.
- **Year:** 2006.
- **First submitted:** 2006-02-01.
- **Primary category:** `gr-qc`.
- **arXiv:** [gr-qc/0602001v1](https://arxiv.org/abs/gr-qc/0602001).
- **Publication:** Phys.Rev.Lett.96:121301,2006.
- **DOI:** [10.1103/PhysRevLett.96.121301](https://doi.org/10.1103/PhysRevLett.96.121301).
- **Local artifacts:** `gr-qc-0602001-eling-guedens-jacobson-non-equilibrium-thermodynamics-spacetime.pdf`, `gr-qc-0602001-source.tar.gz`.
