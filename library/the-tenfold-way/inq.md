...
John C. Baez, Department of Mathematics, University of California, Riverside, and Centre for Quantum Technologies, National University of Singapore.

- [arXiv:2011.14234v1](https://arxiv.org/abs/2011.14234), 21 November 2020. No journal reference recorded.

Files: `tenfold_arxiv_1.tex`.

The source package contains no `abstract` environment — the article is expository and opens directly with an epigraph and prose. The abstract above is transcribed from the arXiv listing rather than from the LaTeX.
