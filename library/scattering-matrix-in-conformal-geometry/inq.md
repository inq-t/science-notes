---
inq.module: "scattering-matrix-in-conformal-geometry"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Authors:** C. Robin Graham and Maciej Zworski.
- **Year:** 2001.
- **First submitted:** 2001-09-14.
- **Primary category:** `math.DG`.
- **arXiv:** [math/0109089v1](https://arxiv.org/abs/math/0109089).
- **Local artifacts:** `0109089-graham-zworski-scattering-matrix-conformal-geometry.pdf`.
