---
inq.module: "stochastic-modes-in-postquantum-gravity"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
Jonathan Oppenheim and Muhammad Sajjad.

- [arXiv:2605.05375v1](https://arxiv.org/abs/2605.05375). No journal reference recorded.

Files: `main.tex`, `definitions.tex`, bibliography `cq_unified.bib`, style files `ninecolors.sty` and `tabularray.sty`, and the arXiv build manifest `00README.json`.
