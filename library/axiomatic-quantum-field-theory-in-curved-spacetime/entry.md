...
- **Authors:** S. Hollands and R. M. Wald.
- **Year:** 2010.
- **First submitted:** 2008-03-13.
- **Primary category:** `gr-qc`.
- **arXiv:** [0803.2003v1](https://arxiv.org/abs/0803.2003).
- **Publication:** Commun.Math.Phys.293:85-125,2010.
- **DOI:** [10.1007/s00220-009-0880-7](https://doi.org/10.1007/s00220-009-0880-7).
- **Local artifacts:** `0803.2003-hollands-wald-axiomatic-qft-curved-spacetime.pdf`.
