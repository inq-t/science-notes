...
Masoud Khalkhali, Department of Mathematics, The University of Western Ontario, London, ON, Canada; and Nathan Pagliaroli, Department of Combinatorics and Optimization, The University of Waterloo, Kitchener, ON, Canada.

- [arXiv:2512.08694v1](https://arxiv.org/abs/2512.08694) [math-ph], 9 December 2025. 47 pages, 7 figures. No journal reference recorded.

Files: `CIRMSurvey.tex`, `CIRMSurvey.out`, `CIRMSurvey.toc`, `00README.json`, and the figures `Bootstraps1.pdf`, `Bootstraps2.pdf`, `Bootstraps_0,1_8.pdf`, `Bootstraps_0,1_8_zoomed.pdf`, `Bootstraps_1,0_10.pdf`, `Curve10.pdf`, `Line100.pdf`, `Cubic_Dirac.jpg`, `anomalous_force_example.png`, `influence_of_g2_various_masses.png`.

The abstract above is transcribed from `\begin{abstract}` in `CIRMSurvey.tex`.
