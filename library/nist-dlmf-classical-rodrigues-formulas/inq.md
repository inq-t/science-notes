...
For the second-kind Chebyshev polynomial, its convention is

\[
\frac{U_n(a)}{n+1}
=\frac{(-1)^n}{2^n(3/2)_n\sqrt{1-a^2}}
\frac{d^n}{da^n}(1-a^2)^{n+1/2}.
\]

- Publisher: National Institute of Standards and Technology.
- Source: [DLMF §18.5(ii), equation 18.5.5 and Table 18.5.1](https://dlmf.nist.gov/18.5#ii).
- Accessed: 2026-09-08.
