...
- [arXiv:2407.13820v2](https://arxiv.org/abs/2407.13820).
- Phys. Rev. D. DOI [10.1103/7whh-9j22](https://doi.org/10.1103/7whh-9j22).

Files: `PCDM.tex`, bibliography `PCDM.bib`, JHEP style files `jheppub2.sty` and `JHEP.bst`, and the arXiv build manifest `00README.json`.
