...
- **Primary record:** [source page](https://www.ulam.ai/research/jacobian.pdf).
- **Publication:** Unattributed manuscript hosted by Ulam.ai, 7 pages (20 July 2026).
- **Local artifacts:** None held in this workspace.

The host is not named as the author. The introduction attributes announcement of the formula to Levent Alpöge. This singular-titled manuscript is distinct from Shuhong Gao's plural-titled arXiv:2608.00222.
