---
inq.module: "local-wick-polynomials-and-time-ordered-products"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Year:** 2001.
- **First submitted:** 2001-03-20.
- **Last revised:** 2001-06-22.
- **Primary category:** `gr-qc`.
- **arXiv:** [gr-qc/0103074v2](https://arxiv.org/abs/gr-qc/0103074).
- **Publication:** Commun.Math.Phys.223:289-326,2001.
- **DOI:** [10.1007/s002200100540](https://doi.org/10.1007/s002200100540).
- **Local artifacts:** `0103074-hollands-wald-local-wick-polynomials-time-ordered-products.pdf`.
