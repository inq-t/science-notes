...
Alain Connes, Collège de France, 3 rue d'Ulm, Paris F-75005 France; and Matilde Marcolli, Max-Planck Institut für Mathematik, Vivatsgasse 7, Bonn D-53111 Germany.

- [arXiv:hep-th/0504085v1](https://arxiv.org/abs/hep-th/0504085), 9 April 2005.
- *J. Geom. Phys.* **56**, 55–85 (2006). DOI [10.1016/j.geomphys.2005.04.004](https://doi.org/10.1016/j.geomphys.2005.04.004).

Files: `JGPren3.tex`.

The source package contains no `abstract` environment — the article opens directly with its first section, "Renormalization: particle physics and Hopf algebras". The abstract above is transcribed from the arXiv listing rather than from the LaTeX.
