---
inq.module: "thermodynamics-of-spacetime-the-einstein-equation-of-state"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
- **Year:** 1995.
- **First submitted:** 1995-04-04.
- **Last revised:** 1995-06-06.
- **Primary category:** `gr-qc`.
- **arXiv:** [gr-qc/9504004v2](https://arxiv.org/abs/gr-qc/9504004).
- **Publication:** Phys.Rev.Lett.75:1260-1263,1995.
- **DOI:** [10.1103/PhysRevLett.75.1260](https://doi.org/10.1103/PhysRevLett.75.1260).
- **Local artifacts:** `gr-qc-9504004-jacobson-thermodynamics-of-spacetime.pdf`, `gr-qc-9504004-source.tar.gz`.
