---
inq.module: "quantum-gravity-coupled-to-matter"
inq.include:
  - "./"
inq.ambient:
  - "**"
...
Johannes Aastrup, Mathematisches Institut, Georg-August-Universität Göttingen; Jesper Møller Grimstrup, The Niels Bohr Institute, University of Copenhagen; and Mario Paschke, Spaß & Wissenschaft, Münster.

- [arXiv:1012.0713v1](https://arxiv.org/abs/1012.0713) [hep-th], 3 December 2010.
- *Class. Quantum Grav.* **28**, 075014 (2011).

Files: `Paper_10.06.28.tex`, `AAAcubes.pdf`, `AAAcubes.pdf_t`.

The abstract above is transcribed from `\begin{abstract}` in `Paper_10.06.28.tex`. A commented-out closing sentence in the source ("This note concludes the analysis presented in arXiv:1003.3802.") is not part of the abstract and is omitted.
