...
- **Authors:** Pablo Bueno, Vincent S. Min, Antony J. Speranza, and Manus R. Visser.
- **Year:** 2017.
- **First submitted:** 2016-12-13.
- **Primary category:** `hep-th`.
- **arXiv:** [1612.04374v1](https://arxiv.org/abs/1612.04374).
- **Publication:** Phys. Rev. D 95, 046003 (2017).
- **DOI:** [10.1103/PhysRevD.95.046003](https://doi.org/10.1103/PhysRevD.95.046003).
- **Local artifacts:** `1612.04374-bueno-min-speranza-visser-higher-order-gravity.pdf`, `1612.04374-source.tar.gz`.
