...
This is the all-direction version of [[mass-scale-calibration/mass-as-a-calibrated-distinction-rate]]. It says that mass is a rate of dimensionless **transfer attenuation** on the physical carrier. It does not yet say that the attenuated depth is entropy, a produced fact, or a unit of area.
...
The precise Yang--Mills consequence can be read from [[exceptional-gauge-realization/exceptional-wilson-same-carrier-factorization]]. On a connected finite graph containing a cycle, put \(\mathcal K_\Gamma=(1-P_{0,\Gamma})\mathcal H_\Gamma\). Then
