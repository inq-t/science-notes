...
The proposed Copernican reversal takes the composition of distinguishable, partially accessible relations as primary. A state, a clock, a causal arena and a local action must be compatible realizations of that composition. Mass would then express the stability of nonvacuum distinctions under the passage between the whole law and its local presentations. The strongest candidate is a calculus of descent that retains its discarded variance, together with an algebraic rigidity theorem that survives refinement. The ingredients below include exact constructions and a new conditional transport lemma; the constitutive law and the continuum Yang–Mills theorem remain open.
...
These arrows are construction targets. Several are already realized together in particular models; no note supplies the entire chain. The higher concept is **stable relational realization**: a complete nonvacuum distinction cannot have arbitrarily small response to every comparison that realizes it.
...
The sought short conceptual discovery is the primitive relation that makes stable descent unavoidable. Its mathematical consequences could be economical even if the continuum verification is substantial. Until that relation is found, the programme's strongest advance is a precise location for the missing necessity: the compatibility between algebraic rigidity and the variance retained through every change of access.
