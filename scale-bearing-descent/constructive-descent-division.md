...
This note treats hard compression of an analysis. [[scale-bearing-descent/coherent-comparison-lifts-and-bounded-descent|Actual regional restriction]] has additional structure: its conditional innovation retains an exterior-information term, and an exact contractive lift transports an existing repair through nested regions. The same companion shows how a factorization of the whole lost analysis realizes the division below as part of a comparison lift. Genuine source extension requires a further construction on the new directions.
