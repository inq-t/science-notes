...
[[scale-bearing-descent/principle-of-stable-realization|The principle of stable realization]] adopts this common-law assertion as an axiom and proves the resulting conditional Clay theorem. Its source repair generates the lower comparison bound, its exact-return clause supplies the quantum theory, and their compatibility produces the mass threshold. It concentrates the remaining existence problem in realizing the stated axiom.
